        ...
        <div class="row justify-content-center height align-items-center">
            <div class="col-lg-8">
                <div class="banner-content text-center">
                    ...
                    <h1 class="text-white text-uppercase">2018 Attendee Profiles</h1>
                    <a href="https://github.com/mostertb/phpsa-2018-profiles#instructions"
                       class="primary-btn d-inline-flex align-items-center"
                       target="_blank">
                        <span class="mr-10">Attendee?</span><span class="lnr lnr-arrow-right"></span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row pt-5 pb-5">
            <div class="col-md-12">
                ...
                <p>
                    ...
                    the <a href="https://github.com/mostertb/phpsa-2018-profiles">phpsa-2018-profiles</a> project (the code that generates
                    this
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="thumbnail">
                            <img src="https://cdn.shopify.com/s/files/1/0051/4802/products/sticker-large_512x512.jpg?v=1368814212"
                                 alt="GitHub Stickers" style="max-width: 100%">
            ...
            <div class="col-md-12">
                ...
                foreach ($kernel->getProfiles() as $index => $profile) {
                    ...
                    <div class="section-top-border">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="<?php echo htmlspecialchars($profile->getProfileImageURL()) ?>"
                                     alt="<?php echo htmlspecialchars($fullname) ?>" class="w-100">
                            </div>
                            <div class="col-md-9 mt-sm-20">
                                <h3><a name="<?php echo $profile->getSlug() ?>"><?php echo htmlspecialchars($fullname) ?></a></h3>
                                <p>
                                    <?php echo htmlspecialchars($profile->getBiography()) ?>
...
<footer>
    <div class="container-fluid">
        <div class="footer-content d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="copy-right-text">Copyright &copy; | All rights reserved to PHP South Africa.
                Themed with <i class="fa fa-heart-o" aria-hidden="true"></i>
                by
                <a href="https://twitter.com/scheMeZa" target="_blank">scheMeZa</a>
            </div>
        </div>
    </div>
</footer>
